...
//      echo "$sql<pre>"; print_r($row); echo "</pre>";
   ...
   /**
    * Returns all Category data found for a given RecipeID.
    *
    * @access   public
    * @param    int      The recipe ID
    * @return   int
    */
   function get_all_category_data($recipe_id)
   {
      $sql = 'SELECT rc.CategoryID, c.CategoryName '.
             'FROM rcp_recipe_category AS rc '.
             'LEFT JOIN rcp_category AS c '.
