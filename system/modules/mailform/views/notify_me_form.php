...
<form action="/about_us/notify_me.php" method="post" name="notify_me" id="notify_me">
...
<td style="text-align:left; vertical-align:top"><?=form_submit(array('name'=>'submit', 'class'=>'submit', 'value'=>'Sign Up'))?></td>
</tr>
