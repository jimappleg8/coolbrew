...
<p class="blockintro">Now, tell us about what we know about what brands the store carries.</p>
<div class="block">
   <dl>
      <dt>Brands:</dt>
      <dd><?=form_textarea(array('name'=>'Brands', 'id'=>'Brands', 'cols' => 50, 'rows' => 2, 'value'=>$this->validation->Brands, 'class'=>'box'));?>
      <?=$this->validation->Brands_error;?></dd>

      <dt>Not Brands:</dt>
      <dd><?=form_textarea(array('name'=>'NotBrands', 'id'=>'NotBrands', 'cols' => 50, 'rows' => 2, 'value'=>$this->validation->NotBrands, 'class'=>'box'));?>
...
<div class="block">
   <dl>
      <dt>Notes:</dt>
      <dd><?=form_textarea(array('name'=>'Notes', 'id'=>'Notes', 'cols' => 50, 'rows' => 10, 'value'=>$this->validation->Notes, 'class'=>'box'));?>
