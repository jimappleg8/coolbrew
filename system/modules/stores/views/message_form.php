...
<head>
   ...
   <title>Tell us about this <?=$brand_name;?> store</title>
...
<div class="store">
   <?=$this->validation->StoreName;?>
   <br /><?=$this->validation->Address1;?>
   <?php if ($this->validation->Address2 != ''): ?><br /><?=$this->validation->Address2;?><?php endif; ?>
   <br /><?=$this->validation->City;?>, <?=$this->validation->State;?> <?=$this->validation->Zip;?> 
