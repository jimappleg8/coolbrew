...
<?php endif; ?>
   ...
   <a href="<?=site_url('cp/stories/index/'.$project_id);?>">Stories</a> | 
   <strong>Project Settings</strong></h1>
...
<form method="post" action="<?=site_url('cp/projects/edit/'.$project_id.'/'.$last_action);?>">
