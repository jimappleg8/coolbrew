...
{	
    ...
    function index()
    {
		...
		$query = $this->usermodel->getUsers($fields, $limit, $where);
    ...
    {      
        ...
        if ($this->validation->run() == FALSE)
		{
	    	...
	    	//if is superadmin display all possible roles
            ...
            {
            	$data['role_options'] = array_keys(array_slice($this->config->item('FAL_roles'), 2));
            }
