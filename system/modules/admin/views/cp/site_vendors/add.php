...
<div id="Wrapper">
   ...
   <a class="admin" href="<?=site_url('cp/vendors/index/'.$vendor_id);?>">Cancel</a>

               </div>
               
   <h1>Add a Vendor Client</h1>
...
<form method="post" action="<?=site_url('cp/site_vendors/add/'.$vendor_id.'/'.$last_action);?>">

<p class="blockintro">Please fill out the information below about this vendor's client.</p>
<div class="block">
   <dl>
...
<div class="action">
   <?=form_submit(array('name'=>'submit', 'class'=>'submit', 'value'=>'Add this client'))?> or <a class="admin" href="<?=site_url('cp/vendors/index/'.$vendor_id);?>">Cancel</a>
</div>
