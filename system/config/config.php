...
|
*/
$config['base_url']	= $COOLBREW['base_url'].'/';
...
|
*/
$config['index_page'] = ltrim($_SERVER['SCRIPT_NAME'], "/");
...
|
*/
$config['language']	= $COOLBREW['default_locale'];
...
|
*/
$config['cache_path'] = DOCPATH.'cache/';
...
$config['cookie_domain']	= $COOLBREW['cookie_domain'];
$config['cookie_path']		= "/";
