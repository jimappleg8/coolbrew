...
class Controller extends CI_Base {
	...
	function _ci_initialize()
	{
		...
		// Change, Begin - coolbrew: add Tag & Collector classes to list
		/*
		// Original
		$classes = array(
							'config'	=> 'Config',
		...
		*/
		...
		{
			// Change, Begin - coolbrew: force loader library to reload
			/*
			// Original
			$this->load =& load_class('Loader');
			// Original
			*/
			$this->load =& load_class('Loader', TRUE, TRUE);
	...
	function _ci_scaffolding()
	{
		...
		require_once(BASEPATH.'libraries/Scaffolding'.EXT);
