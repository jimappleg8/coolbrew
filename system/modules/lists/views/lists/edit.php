...
<form method="post" action="<?=site_url('lists/edit/'.$site_id.'/'.$list_id.'/'.$last_action);?>">
...
<div class="action">
   <?=form_submit(array('name'=>'submit', 'class'=>'submit', 'value'=>'Save changes'))?> or <a class="admin" href="<?=site_url('lists/index/'.$site_id);?>">Cancel</a>
</div>
