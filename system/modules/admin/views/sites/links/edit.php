...
function dodelete()
{
  ...
  {
    document.location = "<?=site_url('sites/links/delete/'.$site_id.'/'.$link_id);?>";
  }
}
...
<?php endif; ?>
   ...
   <a class="admin" href="#" onclick="dodelete()">Delete</a> | <a class="admin" href="<?=site_url('sites/links/index/'.$site_id);?>">Cancel</a>
...
<form method="post" action="<?=site_url('sites/links/edit/'.$link_id.'/'.$last_action);?>">
...
<div class="action">
   <?=form_submit(array('name'=>'submit', 'class'=>'submit', 'value'=>'Save changes'))?> or <a class="admin" href="<?=site_url('sites/links/index/'.$site_id);?>">Cancel</a>
</div>
