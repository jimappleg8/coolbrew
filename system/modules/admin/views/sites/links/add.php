...
<div id="Wrapper">
   ...
   <a class="admin" href="<?=site_url('sites/links/index/'.$site_id);?>">Cancel</a>
...
<form method="post" action="<?=site_url('sites/links/add/'.$site_id.'/'.$last_action);?>">
...
<div class="action">
   <?=form_submit(array('name'=>'submit', 'class'=>'submit', 'value'=>'Add this link'))?> or <a class="admin" href="<?=site_url('sites/links/index/'.$site_id);?>">Cancel</a>
</div>
