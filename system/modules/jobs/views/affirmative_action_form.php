...
<p>Please continue by filling out the OPTIONAL form below. Your resume is already safely submitted so your response to the following form will have no affect on whether we receive your resume.</p>
</td>
</tr>
...
<h1>Voluntary applicant affirmative action information</h1>

<div id="job-form">

<form action="/careers/submit_eeo.php/<?=$resume_id;?>/" method="post" name="submit_eeo" id="submit_eeo">

<?=form_hidden('resume_id', $resume_id);?>
...
<tr>
<td colspan="3"><img src="/images/dot_clear.gif" width="10" height="20" alt=""></td>
</tr>
...
<tr>
<td width="40"><img src="/images/dot_clear.gif" width="40" height="10" alt=""></td>
<td width="60"><img src="/images/dot_clear.gif" width="60" height="10" alt=""></td>
<td width="100%"><img src="/images/dot_clear.gif" width="100" height="10" alt=""></td>
</tr>

<tr>
<td colspan="3"><?=form_submit(array('name'=>'submit', 'class'=>'submit', 'value'=>'Submit your EEO form'))?> or <a class="admin" href="/careers/positions.php">Cancel</a></td>
</tr>
