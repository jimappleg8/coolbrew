...
class Authhelper {
	...
	/**
	 * Sets the ControllerURL variable
	 * @param string $controllerUrl The Url of the main controller.
	 */
	...
	{
		$accessToken = $this->CI->session->userdata('demoToken');
		if ($accessToken != '')
		{
	...
	public function authenticate()
	{
		try
		{
			...
			$this->CI->session->set_userdata('demoToken', $accessToken);
	...
	public function revokeToken()
	{
		...
		if ($accessToken)
		{
			...
			try
			{
				...
				$this->CI->session->unset_userdata('demoToken');
			}
			catch (Google_AuthException $e)
			{
				$this->errorMsg = $e->getMessage();
