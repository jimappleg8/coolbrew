...
function dodelete()
{
  ...
  {
    document.location = "<?=site_url('cp/links/delete/'.$link_id);?>";
  }
}
...
<div id="Wrapper">
   ...
   <a class="admin" href="#" onclick="dodelete()">Delete</a> | <a class="admin" href="<?=site_url('cp/links/index/');?>">Cancel</a>
...
<form method="post" action="<?=site_url('cp/links/edit/'.$link_id.'/'.$last_action);?>">
...
<div class="action">
   <?=form_submit(array('name'=>'submit', 'class'=>'submit', 'value'=>'Save changes'))?> or <a class="admin" href="<?=site_url('cp/links/index/');?>">Cancel</a>
</div>
