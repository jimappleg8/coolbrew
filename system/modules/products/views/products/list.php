...
<?php endif; ?>
   ...
   <?php if ($admin['limited']): ?><a class="admin" href="<?=site_url('products/index/'.$site_id.'/all');?>">Show all</a><?php endif; ?>
               </div>

   <h1><?php if ($admin['limited']): ?>Products in <?=$category['CategoryName'];?><?php else: ?>All active products<?php endif; ?> &mdash; <span><a href="<?=site_url('products/discontinued/'.$site_id);?>">View discontinued products</a></span></h1>
