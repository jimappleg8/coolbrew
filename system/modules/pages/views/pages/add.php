...
<form method="post" action="<?=site_url('pages/add/'.$site_id.'/'.$parent.'/'.$sort.'/'.$last_action);?>">

<p class="blockintro">First, choose a short string ID for the page item. This string is limited to characters, numbers and underlines or dashes.</p>
<div class="block">
   <dl>
...
<div class="block">
   <dl>
      <dt>Page Title:</dt>
      <dd><?=form_input(array('name'=>'PageTitle', 'id'=>'PageTitle', 'maxlength'=>'255', 'size'=>'60', 'value'=>$this->validation->PageTitle));?>
...
<div class="action">
   <?=form_submit(array('name'=>'submit', 'class'=>'submit', 'value'=>'Add this page'))?> or <a class="admin" href="<?=site_url('pages/index/'.$site_id);?>">Cancel</a>
</div>
