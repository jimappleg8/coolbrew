...
<div id="Wrapper">
   ...
   <h1>Edit this Vendor Service</h1>
...
<form method="post" action="<?=site_url('cp/vendor_services/edit/'.$service_id.'/'.$last_action);?>">

<p class="blockintro">Basic service information. The Service Description is used to explain what a service is.</p>
<div class="block">
   <dl>
      <dt class="required"><label for="Name">Service Name:</label></dt>
...
<div class="action">
   <?=form_submit(array('name'=>'submit', 'class'=>'submit', 'value'=>'Save changes'))?> or <a class="admin" href="<?=site_url('cp/vendor_services/index/');?>">Cancel</a>
</div>
