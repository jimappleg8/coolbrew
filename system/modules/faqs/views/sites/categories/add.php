...
<form method="post" action="<?=site_url('sites/categories/add/'.$site_id.'/'.$parent.'/'.$sort.'/'.$last_action);?>">
...
<div class="action">
   <?=form_submit(array('name'=>'submit', 'class'=>'submit', 'value'=>'Add this FAQ category'))?> or <a class="admin" href="<?=site_url('sites/categories/index/'.$site_id);?>">Cancel</a>
</div>
