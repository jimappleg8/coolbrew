...
<form method="post" action="<?=site_url('contests/edit/'.$site_id.'/'.$contest_id.'/'.$last_action);?>">
...
<div class="action">
   <?=form_submit(array('name'=>'submit', 'class'=>'submit', 'value'=>'Save changes'))?> or <a class="admin" href="<?=site_url('contests/index/'.$site_id);?>">Cancel</a>
</div>
