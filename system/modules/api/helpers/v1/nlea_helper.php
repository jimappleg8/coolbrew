...
function draw_line($params)
{
   ...
   if (strtoupper($indent) == "YES")
   {
      ...
      $html_data .= '<img src="http://resources.hcgweb.net/shared/dot_clear.gif" width="11" height="1" alt=""';
      ...
      $html_data .= '<img src="http://resources.hcgweb.net/shared/dot_black.gif" width="219" height="'.$width.'" alt=""';
      if (strtoupper($xhtml) == "YES")
      {
         $html_data .= ' /></td>' . "\n";
      }
   ...
   else
   {
      ...
      $html_data .= '<img src="http://resources.hcgweb.net/shared/dot_black.gif" width="232" height="'.$width.'" alt=""';
      if (strtoupper($xhtml) == "YES")
      {
         $html_data .= ' /></td>' . "\n";
      }
...
function draw_baby_line($params)
{
   ...
   if (strtoupper($indent) == "YES")
   {
      ...
      $html_data .= '<img src="http://resources.hcgweb.net/shared/dot_black.gif" width="157" height="'.$width.'" alt=""';
      if (strtoupper($xhtml) == "YES")
      {
         $html_data .= ' /></td>' . "\n";
      }
   ...
   else
   {
      ...
      $html_data .= '<img src="http://resources.hcgweb.net/shared/dot_black.gif" width="170" height="'.$width.'" alt=""';
      if (strtoupper($xhtml) == "YES")
      {
         $html_data .= ' /></td>' . "\n";
      }
