...
<h2>Stores that carry <?=$product_name;?></h2>
   ...
   <p>We know of <?=count($product_stores);?> stores within <?=$query['radius'];?> miles of <?=$query['zip'];?> that carry <strong><?=$product_name;?></strong>.</p>
...
<h2>Stores that carry <?=$brand_name;?> products</h2>
   ...
   <p>We know of <?=count($brand_stores);?> stores within <?=$query['radius'];?> miles of <?=$query['zip'];?> that carry carry <strong><?=$brand_name;?> products</strong>. Please call the store to find out if they carry the specific product that you are looking for.</p>
...
<h2>Stores that carry some Hain Celestial Group products</h2>
   ...
   <p>We know of <?=count($hcg_stores);?> stores within <?=$query['radius'];?> miles of <?=$query['zip'];?> that carry at least some of the <strong>Hain Celestial Group family of products</strong>. There's a possibility they'll have what you want, but you'll want to call ahead to make sure.</p>
