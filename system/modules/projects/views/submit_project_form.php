...
<form action="/careers/submit_resume.php" method="post" name="submit_resume" id="submit_resume">
...
<tr>
<td colspan="2"><h2>Location and Category</h2></td>
</tr>
...
<?php if ($Title != "None"): ?>
   ...
   <span style="font-size:12px; line-height:1.6em; background:#FF9;"><?=$locations[$LocationID]?></span>
...
<tr>
<td colspan="2"><h2>Resume:<span class="required">*</span></h2></td>
</tr>
...
<tr>
<td colspan="2"><h2>Cover Letter:</h2></td>
</tr>
