...
class Contactus extends Controller {
   ...
   function index($site_id, $offset = 0) 
   {
      ...
      return $this->load->view('sites/contactus/list', NULL, TRUE);
   }
   ...
   function detail($site_id, $message_id, $offset, $this_action) 
   {
      ...
      if ($this->validation->run() == FALSE)
      {
         ...
         return $this->load->view('sites/contactus/detail', NULL, TRUE);
      }
      else
      {
...
/* Location: ./system/modules/mailform/controllers/contactus.php */