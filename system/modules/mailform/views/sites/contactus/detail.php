...
<?php endif; ?>
   ...
   <td class="left">
    ...
    <a class="admin" href="<?=site_url('sites/contactus/index/'.$site_id.'/'.$offset);?>">Cancel</a>

               </div>
               
   <h1>Contact Us: <a href="<?=site_url('sites/contactus/index/'.$site_id.'/'.$offset);?>">Messages</a> (<?=$message_count;?>)<span> | <a href="<?=site_url('sites/contactus_spam/index/'.$site_id.'/'.$offset);?>">Spam</a> (<?=$spam_count;?>)</span> &mdash; Message detail</h1>
...
<form id="messageForm" method="post" action="<?=site_url('sites/contactus/detail/'.$site_id.'/'.$message_id.'/'.$offset.'/'.$last_action);?>">
...
<div class="action">
    <?=form_submit(array('name'=>'submit', 'class'=>'submit', 'value'=>'Save changes'))?> or <a class="admin" href="<?=site_url('sites/contactus/index/'.$site_id.'/'.$offset);?>">Cancel</a>
</div>
