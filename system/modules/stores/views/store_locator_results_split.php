...
<div id="searchTable">
   ...
   <td class="col-distance"><?=$store['Distance'];?> mi</td>
   ...
   <?php else: ?>
      ...
      <?php $plusten = $query['searchradius'] + 10; ?>
      <?php $plustwenty = $query['searchradius'] + 20; ?>

   <p>No stores known to carry <?=$product_name;?> were found within <?=$query['searchradius'];?> miles radius.</p>

   <form id="plus_ten" method="post" action="<?=$action;?>">
   <input type="hidden" name="zip" value="<?=$query['zip'];?>" />
   <input type="hidden" name="productid" value="<?=$query['productid'];?>" />
   <input type="hidden" name="searchradius" value="<?=$plusten;?>" />
   <input type="hidden" name="productfamilyid" value="HNCL" />
   <input type="hidden" name="clientid" value="69" />
   <input type="hidden" name="template" value="default.xsl" />
   <input type="hidden" name="stores" value="1" />
   ...
   <input type="hidden" name="zip" value="<?=$query['zip'];?>" />
   <input type="hidden" name="productid" value="<?=$query['productid'];?>" />
   <input type="hidden" name="searchradius" value="<?=$plustwenty;?>" />
   <input type="hidden" name="productfamilyid" value="HNCL" />
   <input type="hidden" name="clientid" value="69" />
   <input type="hidden" name="template" value="default.xsl" />
   <input type="hidden" name="stores" value="1" />
...
<?php // ------------------------------------------------------------
   ...
   <p>No stores known to carry <strong><?=$brand_name;?> products</strong> were found within <?=$query['searchradius'];?> miles radius.</p>
...
<?php // ------------------------------------------------------------
   ...
   <p>No stores known to carry at least some of the <strong>Hain Celestial Group family of products</strong> were found within <?=$query['searchradius'];?> miles radius.</p>
