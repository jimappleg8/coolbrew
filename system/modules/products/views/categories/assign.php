...
<?php endif; ?>
   ...
   <h1 id="top"><span><a href="<?=site_url('products/edit/'.$site_id.'/'.$product_id.'/'.$last_action);?>">Product Info</a> | <a href="<?=site_url('nleas/edit/'.$site_id.'/'.$product_id.'/'.$last_action);?>">Nutrition Facts</a> | </span><strong>Categories</strong>
...
<?php if ($products['category_exists'] == true): ?>
   ...
   <form method="post" action="<?=site_url('categories/assign/'.$site_id.'/'.$product_id.'/'.$last_action);?>">
   
   <div class="listing">
   
   <?php foreach($category_list AS $cat): ?>

      <?php $fieldname = 'cat'.$cat['CategoryID']; ?>
