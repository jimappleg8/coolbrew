...
<p class="blockintro">Now, give us the basic category information. The Ctegory Description is generally used internally to identify the category, whereas the Category Text is the text displayed on the website.</p>
<div class="block">
   <dl>
...
<div class="action">
   <?=form_submit(array('name'=>'submit', 'class'=>'submit', 'value'=>'Add this category'))?> or <a class="admin" href="<?=site_url('categories/index/'.$site_id);?>">Cancel</a>
</div>
